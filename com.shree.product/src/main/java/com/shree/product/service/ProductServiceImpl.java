...
import com.shree.product.repository.ProductRepository;
...
public class ProductServiceImpl implements ProductService {
	...
	public List<Product> getProducts(String groupByValue, String actualvalue) {
		...
		switch (groupBy) {
		case BRAND:
			return productRepository.findByBrandId(Long.valueOf(actualvalue));
		case COLOR:
			return productRepository.findByColorId(Long.valueOf(actualvalue));
		case SIZE:
